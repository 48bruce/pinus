...
import { IModule, MonitorCallback, MasterAgent, MasterCallback } from 'pinusmod-admin';
import { MonitorAgent } from 'pinusmod-admin';
...
let restart = function (app: Application, agent: MasterAgent, msg: any, cb: MasterCallback) {
    ...
    let request = function (id: string) {
        return (function () {
            agent.request(id, ConsoleModule.moduleId, { signal: msg.signal }, function (msg: any) {
